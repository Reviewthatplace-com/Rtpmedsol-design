...
$(function() {
    "use strict";
     ...
     $(".resendmgrLocation").click(function(){
          $.toast({
          heading: '',
          text: 'Ravi resent access request to owner',
          position: 'top-right',
          loaderBg:'#ff6849',
          icon: 'warning',
          hideAfter: 3500, 
     ...
     //Location Mangement End

     //Add New Practices Start
